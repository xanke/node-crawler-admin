...
<el-menu-item :key="index" v-for="(item, index) in menu.items" :index="item.path">&nbsp;&nbsp;&nbsp;&nbsp;{{item.name}}</el-menu-item>
</el-menu-item-group>
</el-menu>
</div> -->
	...
	<div>  
		<div v-for="secMenu in menuData">
			...
			<div class="h-50" :key="index" v-for="(item, index) in secMenu.child">
