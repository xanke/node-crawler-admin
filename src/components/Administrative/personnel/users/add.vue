		...
		<el-form ref="form" :model="form" :rules="rules" label-width="130px">
			...
			<el-form-item label="部门" prop="structure_id">
				<el-select v-model="form.structure_id" placeholder="请选择部门" class="w-200">
					<el-option :key="index" v-for="(item, index) in orgsOptions" :label="item.title" :value="item.id"></el-option>
				</el-select>
			</el-form-item>
			...
			<el-form-item label="用户组">
				<el-checkbox-group v-model="selectedGroups">
					<el-checkbox :key="index" v-for="(item, index) in groupOptions" :label="item.title" class="form-checkbox"></el-checkbox>
				</el-checkbox-group>
			</el-form-item>
			<el-form-item>
